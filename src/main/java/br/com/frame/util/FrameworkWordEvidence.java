...
public class FrameworkWordEvidence {
    ...
    public void createWordEvidence(WordprocessingMLPackage template, String evidencePath, String fileName)
            throws Exception {
        if (ReportVariables.getDiff() != null) {
            addText(template, "Diferenças Encontradas :");
            addText(template, ReportVariables.getDiff());
            addText(template, "");
        }
        if (ReportVariables.getLogCarga() != null) {
            addText(template, "Log de execução da carga Csharp :");
            addText(template, ReportVariables.getLogCarga());
            addText(template, "");
        }
        if (ReportVariables.getValor_request() != null) {
            addText(template, "Request feito no SalesForce :");
            addText(template, ReportVariables.getValor_request());
            addText(template, "");
        }
        ...
        if (ReportVariables.getValor_recebido() != null) {
            addText(template, "Valores Encontrados :");
            addText(template, ReportVariables.getValor_recebido());
        }
